...
public class CategoryDAO {
	...
	/**
	 * Get the number of children for a given parent node, -1 if absent
	 */
	...
	/**
	 * Rename category 'id' with the new name provided
	 */
	public void renameCategory(int id, String newName) throws SQLException {
		
		String action = "Renaming category with id: " + id + " to name: " + newName;
	 ...
	 */
	public void insertSubtree(int rootID, int parentID, int parentChildCount) throws SQLException {
